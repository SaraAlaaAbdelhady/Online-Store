...
const HeroSection = () => {
  return (
    <>
      <section
        className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 dark:from-slate-950 dark:via-slate-850  dark:to-slate-900 min-h-screen text-white px-4 sm:px-8 py-12 flex items-center shadow-sm transition-colors duration-500 dark:shadow-blue-800
        ...
        <div className="max-w-6xl mx-auto w-full flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 mt-0 md:mt-0">
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
              ...
              <a
                href="#categories"
                className="w-full sm:w-auto cursor-pointer border border-white/40 dark:border-gray-600 hover:bg-white/20 dark:hover:bg-gray-800/50 text-white font-semibold px-8 py-3.5 rounded-lg transition duration-300 text-center dark:border-slate-200/50"
              >
                View Categories
              </a>
            </div>
...
`}</style>
        <div
          className="absolute top-[20%] left-0 speed-line"
          style={{ animationDelay: "0s" }}
        >
          <div className="w-50 h-[3px] rounded-full bg-white/70" />
        </div>
        <div
          className="absolute top-[40%] left-0 speed-line"
          style={{ animationDelay: "0.6s" }}
        >
          <div className="w-50 h-[3px] rounded-full bg-white/40" />
        </div>
        <div
          className="absolute top-[65%] left-0 speed-line"
