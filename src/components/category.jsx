                ...
                {categories.map((category) => {
                    ...
                    return (
                        <Link 
                            ...
                            className={`group relative min-h-30 bg-white border border-slate-200 rounded-xl p-5 sm:p-6 shadow-sm hover:shadow-md transition-all duration-100 hover:border-[var(--cat)] overflow-hidden`}
                        >
                            ...
                            <div className="flex items-start justify-between gap-1">
                                ...
                                <div className="relative mb-3 flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[var(--cat)] overflow-hidden">
                                    <div className="absolute inset-0 bg-black opacity-0 transition-opacity duration-100 group-hover:opacity-15"></div>
                                    <Icon size={24} className="relative z-10 text-white"/>
                                </div> 
                            </div>

                            <div className="absolute bottom-5 left-5 right-5 sm:left-6 sm:right-6 h-px bg-gradient-to-t from-transparent via-slate-200 to-transparent"></div>
                        </Link>
                    )
                })}
            </div>
