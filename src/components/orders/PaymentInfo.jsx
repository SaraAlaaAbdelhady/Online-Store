    ...
    return(
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 mb-0 md:mb-6 p-5">
            <div className="flex items-center gap-2 font-semibold mb-3">
                ...
                <h2 className="text-slate-800 dark:text-slate-200 text-lg">Payment</h2>
            </div>
            {/* payment method */}
            <span className="text-base text-slate-500 dark:text-slate-300 font-medium inline-block mb-4">{order.paymentMethod.charAt(0).toUpperCase() + order.paymentMethod.slice(1)}</span>
            {/* line */}
            <div className="h-px bg-gradient-to-t from-transparent via-slate-200 to-transparent dark:via-slate-700"></div>
            <div className="flex items-center justify-between font-bold text-sm pt-3">
                {/* totalPrice */}
                <p className="text-black dark:text-slate-200">Total</p>
