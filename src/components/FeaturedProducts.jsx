...
const FeaturedProducts = () => {
        ...
        <div className="mx-auto max-w-[1400px]  ">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((item) => (
              ...
              >
                <div className="h-[300px] animate-pulse bg-gray-100"></div>

                <div className="p-5">
                  <div className="h-5 w-3/4 animate-pulse rounded bg-gray-200"></div>

                  <div className="mt-3 h-4 w-1/2 animate-pulse rounded bg-gray-200"></div>

                  <div className="mt-5 h-6 w-1/3 animate-pulse rounded bg-gray-200"></div>

                  <div className="mt-5 h-11 w-full animate-pulse rounded-xl bg-gray-200"></div>
                </div>
              </div>
            ))}
          </div>
  ...
  return (
    <section className="relative bg-white px-12  lg:px-20   py-12 ">
      ...
      {/* Toast */}
      {toast && (
        <div className="fixed right-6 top-6 z-50 flex w-fit max-w-[220px] items-center gap-2 rounded-xl bg-[#111827] px-3 py-2.5 shadow-xl">
      ...
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link
            to="/shop"
            className="flex w-fit items-center gap-2 text-sm font-semibold text-indigo-600 transition hover:text-indigo-800"
          >
            View All
            ...
            return (
              ...
              >
                ...
                <div className="absolute left-0 right-0 top-2 z-20 flex items-center justify-between gap-2 px-4">
                  ...
                  {/* Category */}
                  <span className="max-w-[48%] truncate rounded-full bg-blue-50 px-3 py-1 text-xs font-medium text-blue-700">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white transition ${
                        isInWishlist
                          ? "text-red-500"
                ...
                {/* Image */}
                <div className="relative z-0 h-[300px] overflow-hidden bg-gray-50 px-4 py-4">
                ...
                {/* Product Info */}
                <div className="flex min-h-[245px] flex-col border-t border-gray-100 bg-white p-5">

                  {/* Product Name */}
                  <h3 className="line-clamp-2 min-h-[48px] text-base font-medium leading-6 text-gray-800">
                    {product.name}
                  </h3>
