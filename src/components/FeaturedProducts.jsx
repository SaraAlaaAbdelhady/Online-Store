...
///
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((item) => (
              ...
              >
                <div className="h-[300px] animate-pulse bg-gray-100 dark:bg-gray-800"></div>
          ...
          {featuredProducts.map((product) => {
            ...
            return (
              ...
              >
                ...
                {/* Image */}
                <div className="relative z-0 h-[300px] overflow-hidden bg-gray-50 px-4 py-4 dark:bg-gray-800">
