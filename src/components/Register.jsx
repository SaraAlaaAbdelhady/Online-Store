...
const Register = () => {
  ...
  return (
    <main className="relative min-h-[calc(100vh-80px)]  px-4 py-12 sm:px-6 lg:px-8 bg-gray-50 dark:bg-slate-900">

      {/* Success Toast */}
      {success && (
        <div className="fixed right-5 top-5 z-50 flex items-center gap-3 rounded-lg bg-gray-900 px-4 py-3  text-white shadow-lg">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                <i className="fa-regular fa-user pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-xs text-gray-400"></i>
                ...
                <input
                  ...
                  placeholder="johndoe"
                  disabled={loading}
                  className="h-10 w-full rounded-md border border-gray-300 bg-white pl-9 pr-3 text-sm text-gray-800 outline-none transition placeholder:text-gray-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 disabled:cursor-not-allowed disabled:bg-gray-50 rounded-xl"
                />
              </div>
            </div>
            ...
            <div className="mt-4">
              ...
              <div className="relative">
                <i className="fa-regular fa-envelope pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"></i>
            ...
            <div className="mt-4">
              ...
              <div className="relative">
                <i className="fa-solid fa-lock pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-xs text-gray-400"></i>
