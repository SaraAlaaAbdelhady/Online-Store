...
function StayUpdated() {
    return (
        <div className="bg-gray-50 px-12  lg:px-20   py-12 flex items-center justify-center text-white">
            <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-2xl text-center p-10 space-y-6 w-full">
