...
const Wishlist = () => {
          ...
          <div className="mx-auto max-w-[954px]">
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {[1, 2, 3, 4].map((item) => (
                ...
                >
                  <div className="h-[220px] animate-pulse bg-gray-200"></div>

                  <div className="p-3">
                    <div className="h-4 w-4/5 animate-pulse rounded bg-gray-200"></div>

                    <div className="mt-3 h-5 w-1/2 animate-pulse rounded bg-gray-200"></div>

                    <div className="mt-3 h-8 w-full animate-pulse rounded-lg bg-gray-200"></div>
                  </div>
                </div>
              ))}
            </div>
      ...
      <div className="min-h-screen bg-[#f8fafc]">
        ...
        <main className="px-4 py-6 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-[954px]">
            ...
            {/* Empty Wishlist */}
            <div className="flex min-h-[330px] flex-col items-center justify-center rounded-xl border border-gray-200 bg-white px-6 text-center shadow-sm">
              ...
              <Link
                to="/shop"
                className="mt-5 flex h-9 items-center justify-center rounded-lg bg-indigo-600 px-5 text-xs font-semibold text-white transition hover:bg-indigo-700"
              >
                Continue Shopping
              </Link>
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc]">
      ...
      {/* Toast */}
      {toast && (
        <div className="fixed right-5 top-5 z-50 flex items-center gap-2 rounded-lg bg-[#111827] px-3 py-2 shadow-lg">
            ...
            {wishlist.map((product) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Product Information */}
                  <div className="flex min-h-[95px] flex-col border-t border-gray-100 bg-white p-3">

                    {/* Product Name */}
                    <h2 className="line-clamp-2 min-h-[36px] text-[11px] font-medium leading-[18px] text-gray-700">
                    ...
                    <div className="mt-2 flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-red-400 transition hover:bg-red-50 hover:text-red-500 disabled:cursor-not-allowed disabled:opacity-50"
                      >
                        <i
                          className={
                            isRemoving
      ...
      <div className="mx-auto max-w-[954px] px-4 py-8 sm:px-6 lg:px-0">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
          ...
          <div>
            ...
            <Link
              to="/"
              className="flex items-center gap-2 text-base font-bold text-indigo-600"
            >
              <i className="fa-solid fa-bolt text-sm"></i>
              Koda Store
            </Link>

            <p className="mt-3 max-w-[250px] text-[11px] leading-5 text-gray-500">
          ...
          <div>
            ...
            <div className="mt-3 flex flex-col gap-2">
              ...
              <Link
                to="/shop"
                className="w-fit text-[11px] text-gray-500 transition hover:text-indigo-600"
              >
                Shop
              </Link>
          ...
          <div>
            ...
            <div className="mt-3 flex items-center gap-2">
              ...
              <button
                type="button"
                aria-label="Website"
                className="flex h-7 w-7 items-center justify-center rounded-full bg-gray-50 text-gray-400 transition hover:bg-indigo-50 hover:text-indigo-600"
              >
              ...
              <Link
                to="/wishlist"
                aria-label="Wishlist"
                className="flex h-7 w-7 items-center justify-center rounded-full bg-gray-50 text-gray-400 transition hover:bg-indigo-50 hover:text-red-500"
              >
